<?php
         ...
         */
         ...
         function viewAsResult($searchTerm,$url = ""){
             ...
             echo "
                <div class='profile'>
                    ...
                    <ul>
                        <li style='top:1em;left:-1em;font-size:1.4em;'><a style='position:relative;right:230px;text-decoration:none;' href='browsePage.php?email=$this->email' > $this->screenName </a></li>
         ...
         function viewAsChat($interactor){
             ...
             echo "
                ...
                <div class='little'>
                    <a href='browsePage.php?email=$this->email'>
                         <img src='$this->profilePhoto' alt='profile picture'/>
                    </a>
                    <a href='browsePage.php?email=$this->email' style='top:0.6em;left:6em;font-size:1.2em;'> $this->screenName </a>
                    <a href='messagePage.php?nemail=$this->email&add=yes&email=$interactor' style='bottom:1.6em;left:9em;font-size:0.8em;'> $string </a>
    ...
    <form action="editPage.php" method="post" enctype="multipart/form-data" class="editableForm">
          ...
          <div class="col-3">
	        <label>
	          PROFILE HEADLINE 
	          <input <?php echo "value='$this->profileHeadline'" ?> name="profileHeadline" type="text" required/>
	        </label>
	      </div>
	      ...
	      <label>
	       LOCATION
	          <select tabindex="3" name="location" required>
